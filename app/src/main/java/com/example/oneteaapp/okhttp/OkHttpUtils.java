...
public class OkHttpUtils {
    ...
    /**
     * Post请求发送JSON数据(包含header)
     * 参数一：请求Url
     * 参数二：请求的JSON
     * 参数三：请求回调
     */
    public static void doPostJsonWithHeader(String url, String jsonParams, RequestParams header,
                                            final HttpCallBack callback, final int requestId) {
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), jsonParams);
