package com.example.oneteaapp.view.flowlayout;
...
public class ScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_re);
        //默认账号
        String username = "007";
        //初始化数据库
        ...
        mRecordsAdapter = new TagAdapter<String>(recordList) {
            ...
            public View getView(FlowLayout parent, int position, String s) {
                TextView tv = (TextView) LayoutInflater.from(ScanActivity.this).inflate(R.layout.tab_item,
                        tagFlowLayout, false);
                //为标签设置对应的内容
                tv.setText(s);
                return tv;
