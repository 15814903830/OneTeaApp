        ...
        web_webactivity.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("410") || url.contains("330")|| url.contains("415")) {
                    ...
                    startActivity(new Intent(WebActivity.this, CechargeActivity.class));
                }else if (url.contains("yaoqing")){
                    CouponDialog();
                }else {
                    WebActivity2.actionStart(WebActivity.this, url);
                }
                return true;
            }
...
//    }
    ...
    private void CouponDialog() {
        ShareWeiXinDialog shareWeiXinDialog = new ShareWeiXinDialog(WebActivity.this) {
            @Override
